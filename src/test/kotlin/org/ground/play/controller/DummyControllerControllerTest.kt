...
@MicronautTest
class DummyControllerControllerTest(private val embeddedServer: EmbeddedServer) {
    ...
    fun testIndex() {
        ...
        assertEquals(HttpStatus.OK, client.toBlocking().exchange("/dummyController", String::class.java).status())
        client.close()
    }
}
